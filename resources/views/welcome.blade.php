...
<head>
    ...
    <style>
        body {
            background-image: linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5) ), url("{{ asset('background2.jpg') }}");
        ...
        @isset($profile)
            <div class="col-lg-12 my-4">
                <div class=" row-cols-md-1 font-bold text-center">
                    <img src="{{ asset('storage/' . $profile->logo) }}" class=" img-circle img-fluid img-thumbnail"
                        alt="Lcc logo" style=" height:150px;">
                </div>
                <div class=" row-cols-md-1 font-bold text-center">
                ...
                <div class=" row my-4 m-auto font-bold justify-content-center">
